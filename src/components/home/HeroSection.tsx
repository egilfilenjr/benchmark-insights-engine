...
const HeroSection = () => {
  return <section className="relative bg-gradient-to-b from-softgray-50 to-white pt-24 pb-24 lg:pt-28 lg:pb-32 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden max-w-lg mx-auto animate-scale-in">
              <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=1000" alt="Marketing dashboard analytics" className="w-full h-auto" />
