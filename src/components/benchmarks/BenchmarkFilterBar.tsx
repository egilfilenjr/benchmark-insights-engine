// src/components/benchmarks/BenchmarkFilterBar.tsx
...
type BenchmarkFilterBarProps = {
  options: BenchmarkOption[];
  selected: string;
  onChange: (value: string) => void;
};

export function BenchmarkFilterBar({ options, selected, onChange }: BenchmarkFilterBarProps) {
  ...
  return (
    <div className="flex items-center space-x-2">
      <label htmlFor="benchmark-filter" className="text-sm font-medium text-gray-700">
        Filter:
      </label>
      <select
        id="benchmark-filter"
